(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
  [0],
  {
    ...
    elyg: function (t, e, r) {
      ...
      function R(t, e, r) {
        return { url: S(t.pathname, e), as: r ? S(t.pathname, r) : r };
      }
      function E(t, e) {
              ...
              value: (function () {
                var e = a(
                  o.mark(function e(r, n, a, i) {
                    var u, s, l, g, m, b, S, P, k, R, E, L, O, j, C, I, A, T;
                    return o.wrap(
                      function (e) {
                        for (;;)
                          switch ((e.prev = e.next)) {
                            ...
                            case 21:
                              if (
                                ((l = e.sent),
                                l.__rewrites,
                                (g = (0, p.parseRelativeUrl)(n)),
                                (b = (m = g).pathname),
                                (S = m.searchParams),
                                (g = this._resolveHref(g, s)).pathname !== b &&
                                  ((b = g.pathname),
                                  (n = (0, h.formatWithValidation)(g))),
                                (P = (0, d.searchParamsToUrlQuery)(S)),
                                (b = b
                                  ? (0, c.removePathTrailingSlash)(_(b))
                                  : b),
                                this.urlIsNew(u) || (r = 'replaceState'),
                                (k = (0, c.removePathTrailingSlash)(b)),
                                (R = i.shallow),
                                (E = void 0 !== R && R),
                                (L = _((L = a))),
                                !(0, f.isDynamicRoute)(k))
                              ) {
                                e.next = 47;
                                break;
                              }
                              if (
                                ((O = (0, p.parseRelativeUrl)(L)),
                                (j = O.pathname),
                                (C = (0, y.getRouteRegex)(k)),
                                (I = (0, v.getRouteMatcher)(C)(j)))
                              ) {
                                e.next = 46;
                                break;
                              }
                            ...
                            case 51:
                              return (
                                ...
                                this.changeState(r, n, a, i),
                                (e.next = 58),
                                this.set(k, b, P, u, A).catch(function (t) {
                            ...
                            case 58:
                              ...
                              throw (
                                (t.events.emit('routeChangeError', T, u), T)
                              );
                            case 61:
                              return (
            ...
            },
            {
              ...
              value: function (t) {
                ...
                return this.sdc[r]
                  ...
                  : E(t, this.isSsr).then(function (t) {
                      return (e.sdc[r] = t), t;
                    });
              }
            },
      ...
      (e.default = L), (L.events = (0, l.default)());
    },
    'g/15': function (t, e, r) {
      'use strict';
      var n = r('o0o1'),
